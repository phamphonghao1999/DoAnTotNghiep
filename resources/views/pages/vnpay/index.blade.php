...
{{--         <script src="{{asset('public/frontend/assets/jquery-1.11.3.min.js')}}"></script> --}}
    ...
    <body>
        ...
        <div class="container">
            ...
            <h3>Thanh toán đơn hàng qua VNPAY</h3>
            <div class="table-responsive">
                <form action="{{URL::to('/thanhtoan-onlines')}}" id="create_form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea style="resize: none;" class="form-control" cols="20" id="order_desc" name="order_desc" rows="2">Thanh toán tiền mua sản phẩm</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-default">Thanh toán Popup</button>
